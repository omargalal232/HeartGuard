...
def predict_abnormality(file_path):
    ...
    svm = joblib.load(r"ML model\svm_model.pkl")  
    scaler = joblib.load(r"ML model\scaler.pkl")
    pca = joblib.load(r"ML model\pca.pkl")
...
if __name__ == "__main__":
    ...
    directory_path = r"ML model\raw\demo sounds"
