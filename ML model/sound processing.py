...
data_dir = [r"ML model\raw\dataset'\training-a", 
            r"ML model\raw\dataset'\training-b", 
            r"ML model\raw\dataset'\training-c",
            r"ML model\raw\dataset'\training-d",
            r"ML model\raw\dataset'\training-e",
            r"ML model\raw\dataset'\training-f"]  

label_file = os.path.join(data_dir[0], r"c:\Users\Egy Sky\Desktop\heart guard flutter app\HeartGuard\ML model\raw\dataset'\annotations\Online_Appendix_training_set.csv")  
